            ...
            <section className="relative min-h-[60vh] flex items-center justify-center pt-32 pb-20 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <motion.h1
                            className="text-5xl md:text-6xl font-display font-light tracking-tight text-foreground mb-6"
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.8, delay: 0.2 }}
                        >
                            Wealth Management <span className="text-ph font-normal">Marketing Blog</span>
                        </motion.h1>
                        ...
                        >
                            Expert insights on digital marketing, lead generation, and compliance strategies for RIAs, IARs, and family offices
                        </motion.p>
                    </div>
                </div>
            </section>
